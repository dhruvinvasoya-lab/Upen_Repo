...
public void amazon() {
    ...
    tg.customScriptEnd();
    tg.wait(10);
    if (tg.performAssert("ele_OpenMenuButton", ComparisonType.IS_INVISIBLE)) {
        tg.wait(10);
    } else {
        ...
        tg.pullToRefresh("ele_OpenMenuButton");
...
public void browser() {
    ...
    tg.customScriptEnd();
    tg.wait(10);
    if (tg.performAssert("ele_Firstname0", ComparisonType.IS_INVISIBLE)) {
        tg.wait(10);
    } else {
...
public void jshondouble() {
    ...
    tg.customScriptEnd();
    tg.wait(10);
    JSONObject var_Data = tg.getJsonData("https://testing.testgrid.io/s/csv-to-json/20240531/9ZfqyP.json");
...
public void repeat() {
    ...
    tg.wait(2);
    tg.type("ele_Firstname0", var_Name, true);
    tg.wait(3);
    while (tg.verify.isEqualTo("ele_Firstname0", var_Name)) {
        tg.printLogs("Equal");
        tg.wait(2);
        tg.type("ele_Firstname0", var_Name, true);
        while (tg.verify.isNotEqualTo("ele_Firstname0", "FirstFirst")) {
...
public void script() {
    ...
    if (tg.performAssert("ele_GotitButton", ComparisonType.IS_INVISIBLE)) {
        ...
        tg.wait(8);
        tg.customScriptStart();
        driver.findElement(By.xpath("//android.widget.EditText[@hint='મોબાઇલ નંબર અથવા ઈમેઇલ']")).sendKeys("upendra@gmail.com");
        tg.customScriptEnd();
        tg.wait(3);
        tg.customScriptStart();
        driver.findElement(By.xpath("//android.widget.EditText[@hint='પાસવર્ડ']")).sendKeys("Goswami@12");
        tg.customScriptEnd();
        tg.wait(4);
        tg.customScriptStart();
...
public void tdm() {
    ...
    tg.customScriptEnd();
    tg.wait(10);
    tg.type("ele_Firstnamereg", "#TGITVAR.Firstname", true);
    tg.wait(4);
    tg.type("ele_Lastnamereg", "#TGITVAR.Lastname", true);
    tg.wait(2);
    tg.close();
}
...
public void tdmtgit1() {
    ...
    tg.customScriptEnd();
    tg.wait(10);
    tg.type("ele_Firstnamereg", "upendra", true);
    tg.wait(4);
    tg.type("ele_Lastnamereg", "goswami", true);
    tg.wait(2);
    tg.close();
}

    @Test
public void tdmtgit2() {
    tg.openDevice();
    tg.wait(5);
    tg.testFunction("chromebrowser");
    tg.wait("ele_SearchortypeURLEditText1", ComparisonType.IS_VISIBLE);
    ...
    tg.customScriptEnd();
    tg.wait(10);
    tg.type("ele_Firstnamereg", "raj", true);
    tg.wait(4);
    tg.type("ele_Lastnamereg", "singh", true);
    tg.wait(2);
    tg.close();
}

    @Test
public void tdmtgit3() {
    tg.openDevice();
    tg.wait(5);
    tg.testFunction("chromebrowser");
    tg.wait("ele_SearchortypeURLEditText1", ComparisonType.IS_VISIBLE);
    ...
    tg.customScriptEnd();
    tg.wait(10);
    tg.type("ele_Firstnamereg", "rahul", true);
    tg.wait(4);
    tg.type("ele_Lastnamereg", "shukla", true);
    tg.wait(2);
    tg.close();
}
...
public void type() {
    ...
    tg.wait(5);
    tg.check.isVisible("ele_Logo");
    tg.check.contains("ele_Logo", 2);
    tg.check.isVisible("ele_EnteremailaddressEditText");
    tg.type("ele_EnteremailaddressEditText", "upen@gmail.com", true);
    tg.wait(3);
    tg.check.isVisible("ele_EnterpasswordEditText");
    // comment: using encrypted for password
    tg.typeEncrypted("ele_EnterpasswordEditText", "UUCu+ArPg4Ph1Bz87AWKVg==:MTIzNDU2Nzg5MTAxMTEyMQ==", true);
    tg.wait(2);
...
public void urrunner() {
    ...
    public static void demodata() {
        ...
        tg.check.isVisible("ele_Firstname0");
        tg.wait("ele_Firstname0", ComparisonType.IS_VISIBLE);
        tg.type("ele_Firstname0", var_Fname, true);
